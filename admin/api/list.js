        ...
        req.list.model.findById(id).exec(function (err, item) {
            ...
            if (!req.user.isAdmin
                ...
                && ((!item.createdBy) //hence, prevent removal    
                    ||
                    (item.createdBy && ( //all non-admin items are tracked using createdBy 
        ...
        (function () {
            ...
            query.exec(function (err, items) {
                ...
                locals = {
                    ...
                    columns: columns,
                    item: items[0],
                    csrf_query: req.query.csrf_query,
                    _: _
                };
                row = jade.renderFile(__dirname + '/../../templates/partials/row.jade', locals);
                pagination = jade.renderFile(__dirname + '/../../templates/partials/pagination.jade', {
